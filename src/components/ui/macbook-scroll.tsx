...
export const MacbookScroll = ({
  ...
  return <div ref={ref} className="flex min-h-[200vh] shrink-0 scale-[0.35] transform flex-col items-center justify-start [perspective:800px] sm:scale-50 md:scale-100 md:py-80 py-[38px]">
      <motion.h2 style={{
